...
<head>
	...
	<link rel="icon" type="image/ico" href="../img/gyxc/icon.png">
	<style>
		/*自定义 字体*/
		@font-face {
...
<body class="is-preload">
	...
	<div id="wrapper">
		<!-- Header -->
		<header id="header">
			<h1><strong>📷我们的相册</strong>&nbsp;&nbsp;&nbsp;<a id="backhome" href="../html/gyxc.html">返回首页</a></h1>
			<nav>
				<ul>
				...
				<div class="inner split">
					<div>
						<section>
							...
							<p>记录时间：2022年 —— 2023年</p>
							<p>是建模，亦是我们</p>
						</section>
						<span style="color: #b5b5b5; font-size: 0.8em;">
						</span>
						<p class="copyright">
							<b>&copy; 光遇小站 </b> &nbsp; By 李子凡 / 郭雅雪.
						</p>
						<div>
						</div>
					</div>
